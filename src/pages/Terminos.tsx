    ...
    <div className="min-h-screen flex flex-col bg-brand-cream">
      ...
      <div className="flex-1 max-w-lg mx-auto px-4 pt-20 pb-8">
        <div className="flex items-center gap-3 mb-6 pt-4">
          ...
          <h1 className="font-heading font-black text-brand-navy text-2xl">Términos y Condiciones</h1>
        </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <Section icon={<Shield className="w-5 h-5" />} title="Derecho de Reserva de Admisión">
  ...
  return (
    <div className="glass-card rounded-3xl p-5">
      <div className="flex items-center gap-2 mb-3">
        <span className="text-brand-coral">{icon}</span>
        <h2 className="font-heading font-bold text-brand-navy text-base">{title}</h2>
      </div>
      <div className="font-body text-brand-navy/70 text-sm leading-relaxed">{children}</div>
    </div>
  )
}
