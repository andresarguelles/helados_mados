      ...
      <div className="max-w-lg mx-auto px-4 flex flex-col items-center gap-4">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            aria-label="TikTok de Helados Mados"
            className="hover:text-brand-rosa transition-colors"
          >
            <TikTokIcon className="w-5 h-5" />
          </a>
          <a
            href="https://www.instagram.com/heladosmados"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Instagram de Helados Mados"
            className="hover:text-brand-rosa transition-colors"
          >
            <InstagramIcon className="w-5 h-5" />
          </a>
          <a
            href="https://www.facebook.com/profile.php?id=61557533391525"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook de Helados Mados"
            className="hover:text-brand-rosa transition-colors"
          >
            <FacebookIcon className="w-5 h-5" />
          </a>
          <a
            href="https://www.youtube.com/@heladosmados"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="YouTube de Helados Mados"
            className="hover:text-brand-rosa transition-colors"
          >
